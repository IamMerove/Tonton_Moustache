...
import remarkGfm from 'remark-gfm';   // pour les tables, listes, etc.
 ...
 const renderPage = () => {
    switch (currentPage) {
      ...
      case 'history':
        return <History />;                            
      case 'quests':
        return <div className="page-placeholder">🎯 Quêtes (à venir)</div>;
      case 'achievements':
        return <div className="page-placeholder">🏆 Succès (à venir)</div>;
      case 'stats':
        return <div className="page-placeholder">📊 Statistiques (à venir)</div>;
      case 'settings':
